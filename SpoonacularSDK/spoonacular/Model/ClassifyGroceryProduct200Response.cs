...
namespace spoonacular.Models
{
    ...
    /// </summary>
    [DataContract(Name = "classifyGroceryProduct_200_response")]
    public partial class ClassifyGroceryProduct200Response : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ClassifyGroceryProduct200Response" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected ClassifyGroceryProduct200Response() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="ClassifyGroceryProduct200Response" /> class.
        /// </summary>
        ...
        public ClassifyGroceryProduct200Response(string cleanTitle = default(string), string image = default(string), string category = default(string), List<string> breadcrumbs = default(List<string>), int usdaCode = default(int))
        {
            // to ensure "cleanTitle" is required (not null)
            if (cleanTitle == null)
            {
                throw new ArgumentNullException("cleanTitle is a required property for ClassifyGroceryProduct200Response and cannot be null");
            }
            this.CleanTitle = cleanTitle;
            // to ensure "image" is required (not null)
            if (image == null)
            {
                throw new ArgumentNullException("image is a required property for ClassifyGroceryProduct200Response and cannot be null");
            }
            this.Image = image;
            // to ensure "category" is required (not null)
            if (category == null)
            {
                throw new ArgumentNullException("category is a required property for ClassifyGroceryProduct200Response and cannot be null");
            }
            this.Category = category;
            // to ensure "breadcrumbs" is required (not null)
            if (breadcrumbs == null)
            {
                throw new ArgumentNullException("breadcrumbs is a required property for ClassifyGroceryProduct200Response and cannot be null");
            }
