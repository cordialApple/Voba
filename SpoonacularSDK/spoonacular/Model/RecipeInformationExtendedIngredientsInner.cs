...
namespace spoonacular.Models
{
    ...
    /// </summary>
    [DataContract(Name = "RecipeInformation_extendedIngredients_inner")]
    public partial class RecipeInformationExtendedIngredientsInner : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="RecipeInformationExtendedIngredientsInner" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected RecipeInformationExtendedIngredientsInner() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="RecipeInformationExtendedIngredientsInner" /> class.
        /// </summary>
        ...
        public RecipeInformationExtendedIngredientsInner(string aisle = default(string), decimal amount = default(decimal), string consistency = default(string), int id = default(int), string image = default(string), RecipeInformationExtendedIngredientsInnerMeasures measures = default(RecipeInformationExtendedIngredientsInnerMeasures), List<string> meta = default(List<string>), string name = default(string), string original = default(string), string originalName = default(string), string unit = default(string))
        {
            // to ensure "aisle" is required (not null)
            if (aisle == null)
            {
                throw new ArgumentNullException("aisle is a required property for RecipeInformationExtendedIngredientsInner and cannot be null");
            }
            this.Aisle = aisle;
            this.Amount = amount;
            ...
            if (consistency == null)
            {
                throw new ArgumentNullException("consistency is a required property for RecipeInformationExtendedIngredientsInner and cannot be null");
            }
            ...
            if (image == null)
            {
                throw new ArgumentNullException("image is a required property for RecipeInformationExtendedIngredientsInner and cannot be null");
            }
            this.Image = image;
            // to ensure "name" is required (not null)
            if (name == null)
            {
                throw new ArgumentNullException("name is a required property for RecipeInformationExtendedIngredientsInner and cannot be null");
            }
            this.Name = name;
            // to ensure "original" is required (not null)
            if (original == null)
            {
                throw new ArgumentNullException("original is a required property for RecipeInformationExtendedIngredientsInner and cannot be null");
            }
            this.Original = original;
            // to ensure "originalName" is required (not null)
            if (originalName == null)
            {
                throw new ArgumentNullException("originalName is a required property for RecipeInformationExtendedIngredientsInner and cannot be null");
            }
            this.OriginalName = originalName;
            // to ensure "unit" is required (not null)
            if (unit == null)
            {
                throw new ArgumentNullException("unit is a required property for RecipeInformationExtendedIngredientsInner and cannot be null");
            }
            this.Unit = unit;
        ...
        public RecipeInformationExtendedIngredientsInnerMeasures Measures { get; set; }
