...
namespace spoonacular.Models
{
    ...
    /// </summary>
    [DataContract(Name = "guessNutritionByDishName_200_response_calories")]
    public partial class GuessNutritionByDishName200ResponseCalories : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="GuessNutritionByDishName200ResponseCalories" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected GuessNutritionByDishName200ResponseCalories() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="GuessNutritionByDishName200ResponseCalories" /> class.
        /// </summary>
        ...
        public GuessNutritionByDishName200ResponseCalories(GuessNutritionByDishName200ResponseCaloriesConfidenceRange95Percent confidenceRange95Percent = default(GuessNutritionByDishName200ResponseCaloriesConfidenceRange95Percent), decimal standardDeviation = default(decimal), string unit = default(string), decimal value = default(decimal))
        {
            // to ensure "confidenceRange95Percent" is required (not null)
            if (confidenceRange95Percent == null)
            {
                throw new ArgumentNullException("confidenceRange95Percent is a required property for GuessNutritionByDishName200ResponseCalories and cannot be null");
            }
            ...
            if (unit == null)
            {
                throw new ArgumentNullException("unit is a required property for GuessNutritionByDishName200ResponseCalories and cannot be null");
            }
            this.Unit = unit;
            this.Value = value;
        }
