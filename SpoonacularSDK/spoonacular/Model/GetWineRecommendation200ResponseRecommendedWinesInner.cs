...
namespace spoonacular.Models
{
    ...
    /// </summary>
    [DataContract(Name = "getWineRecommendation_200_response_recommendedWines_inner")]
    public partial class GetWineRecommendation200ResponseRecommendedWinesInner : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="GetWineRecommendation200ResponseRecommendedWinesInner" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected GetWineRecommendation200ResponseRecommendedWinesInner() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="GetWineRecommendation200ResponseRecommendedWinesInner" /> class.
        /// </summary>
        ...
        public GetWineRecommendation200ResponseRecommendedWinesInner(int id = default(int), string title = default(string), decimal averageRating = default(decimal), string description = default(string), string imageUrl = default(string), string link = default(string), string price = default(string), int ratingCount = default(int), decimal score = default(decimal))
        {
            this.Id = id;
            // to ensure "title" is required (not null)
            if (title == null)
            {
                throw new ArgumentNullException("title is a required property for GetWineRecommendation200ResponseRecommendedWinesInner and cannot be null");
            }
            this.Title = title;
            ...
            if (description == null)
            {
                throw new ArgumentNullException("description is a required property for GetWineRecommendation200ResponseRecommendedWinesInner and cannot be null");
            }
            this.Description = description;
            // to ensure "imageUrl" is required (not null)
            if (imageUrl == null)
            {
                throw new ArgumentNullException("imageUrl is a required property for GetWineRecommendation200ResponseRecommendedWinesInner and cannot be null");
            }
            this.ImageUrl = imageUrl;
            // to ensure "link" is required (not null)
            if (link == null)
            {
                throw new ArgumentNullException("link is a required property for GetWineRecommendation200ResponseRecommendedWinesInner and cannot be null");
            }
            this.Link = link;
            // to ensure "price" is required (not null)
            if (price == null)
            {
                throw new ArgumentNullException("price is a required property for GetWineRecommendation200ResponseRecommendedWinesInner and cannot be null");
            }
            this.Price = price;
