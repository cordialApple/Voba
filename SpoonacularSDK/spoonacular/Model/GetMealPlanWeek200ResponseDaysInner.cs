...
namespace spoonacular.Models
{
    ...
    /// </summary>
    [DataContract(Name = "getMealPlanWeek_200_response_days_inner")]
    public partial class GetMealPlanWeek200ResponseDaysInner : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="GetMealPlanWeek200ResponseDaysInner" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected GetMealPlanWeek200ResponseDaysInner() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="GetMealPlanWeek200ResponseDaysInner" /> class.
        /// </summary>
        ...
        public GetMealPlanWeek200ResponseDaysInner(GetMealPlanWeek200ResponseDaysInnerNutritionSummary nutritionSummary = default(GetMealPlanWeek200ResponseDaysInnerNutritionSummary), GetMealPlanWeek200ResponseDaysInnerNutritionSummary nutritionSummaryBreakfast = default(GetMealPlanWeek200ResponseDaysInnerNutritionSummary), GetMealPlanWeek200ResponseDaysInnerNutritionSummary nutritionSummaryLunch = default(GetMealPlanWeek200ResponseDaysInnerNutritionSummary), GetMealPlanWeek200ResponseDaysInnerNutritionSummary nutritionSummaryDinner = default(GetMealPlanWeek200ResponseDaysInnerNutritionSummary), decimal date = default(decimal), string day = default(string), List<GetMealPlanWeek200ResponseDaysInnerItemsInner> items = default(List<GetMealPlanWeek200ResponseDaysInnerItemsInner>))
        {
            this.Date = date;
            // to ensure "day" is required (not null)
            if (day == null)
            {
                throw new ArgumentNullException("day is a required property for GetMealPlanWeek200ResponseDaysInner and cannot be null");
            }
            this.Day = day;
        ...
        public List<GetMealPlanWeek200ResponseDaysInnerItemsInner> Items { get; set; }
